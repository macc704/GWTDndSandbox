...
public class CopyOfSandbox implements EntryPoint {
	...
	// // examples
	// final PickupDragController pickupDragController = new
	...
	// // demoDragHandler.
	// //Widget w =
	// DraggableFactory.createDraggableRedBox(pickupDragController);
	...
	// String t =
	// "You can resize this panel by any of the four edges or corners.\n";
	// for (int i = 0; i < 3; i++) {
